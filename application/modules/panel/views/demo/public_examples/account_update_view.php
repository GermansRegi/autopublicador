...
<section class="col-md-6">
	...
	<?php echo form_open(uri_string(),array('id'=>'edit_user'));?>
      ...
      <section class="form-group">    
        ...
        <section class="form-group">    
           ...
           <input type="text" class="form-control " value="<?php echo $user['upro_first_name']; ?>"/>
            
      </section>
      	<div class="text-center col-sm-12">
			
			<input class="btn btn-primary" type="submit" name="change_password" id="submit" value="Guardar"	/>
		</div>
      </form>
</section>
<section class="col-md-6">
