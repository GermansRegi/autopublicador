...
<body>
	...
	<p> Por favor acceda a este enlace para <?php echo anchor('panel/manual_reset_forgotten_password/'.$user_id.'/'.$forgotten_password_token, 'Restablecer su contraseña')));?></p>
        <p>
            Saludos,<br/>
