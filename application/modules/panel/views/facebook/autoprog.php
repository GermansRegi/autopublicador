					...
					<form method="post" id="periodicasmultiple" action="<?php echo base_url()?>panel/facebook/prog_periodicas" >
						...
						<div class="row form-group"	>
							<div class="col-lg-4 ">
								...
								<div class="col-lg-12">
									<div class="col-lg-12"><a class="btn btn-default showHide" >Crear Carpeta</a></div>
									<div  class="col-lg-12 divCreateFolder clearfix  hidden"  >
										<form id="createFolderProg" method="post" action="<?php echo base_url()?>panel/commonsocial/createFolderAutoProg/fb/bbdd"  class="form-horitzonal">
