...
*/
	...
	*/
	...
	$config['database']['user_acc']['join'] = 'user_accounts.user_app';
	$config['database']['user_acc']['columns']['id'] = 'user_app';
	...
	*/
	...
	$config['database']['custom']['user_profile']['custom_columns'] = array(
		'upro_first_name','upro_last_name','upro_address','upro_city','upro_country','upro_timezone_offset');
...
*/
	...
	*/
	$config['security']['static_salt'] = 'mmmm!';
	...
	*/
     ...
     */
    $config['settings']['privilege_sources'] = array('group');
	...
	*/
	...
	$config['email']['site_title'] = "Socialsuites";
