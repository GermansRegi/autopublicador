		...
		<div role="tabpanel">
			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="bbdd">  
					...
					<div class="row"	>
						<div class="col-lg-3">
							<input type="submit" value="Guardar Bases de datos" class="btn btn-primary">
						</div>
						<div class="col-lg-9">
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								foreach ($autoprog['basededatos'] as $prog) {
									...
									?>
									<td><a href="<?php echo base_url()?>panel/commonsocial/editar/<?php echo $prog->accountid.(($prog->type=='user')?'/u':'/a'); ?>" class="btn btn-default btn-ms" data-toggle='ajaxModal'> <i  class="fa fa-edit"></i></a>
										<a  class="btn btn-danger deleteautoprog data-id="<?php echo $prog->accountid?>" btn-ms" > <i  class="fa fa-trash-o"></i></a>
									</td>
									<?php
									echo "</tr>";
								}
				...
				<div role="tabpanel" class="tab-pane" id="anuncios">  
					...
					<div class="row">
						<div class="col-lg-3">
							<input type="submit" value="Guardar bases de  anuncios" class="btn btn-primary">
						</div>
						<div class="col-lg-9">
							<label class="control-label ">Cuentas:</label>
					...
					<tbody>
						...
						foreach ($autoprog['anuncios'] as $prog) {
							...
							?>
							<td><a href="<?php echo base_url()?>panel/commonsocial/editar/<?php echo $prog->accountid.(($prog->type=='user')?'/u':'/a'); ?>" class="btn btn-default btn-ms" data-toggle='ajaxModal'> <i  class="fa fa-edit"></i></a>
								<a  class="btn btn-danger deleteautoprog btn-ms" data-id="<?php echo $prog->accountid?>" > <i  class="fa fa-trash-o"></i></a>
							</td>
							<?php
							echo "</tr>";
						}
