...
ech base_url() sense haver d posar cap altre cosa sorrtis el arrel del controlador
http://localhost/carpeta/
en tits els moduls
		// Note: This is only included 11to create base urls for purposes of this demo only and are not necessarily considered as 'Best practice'.
